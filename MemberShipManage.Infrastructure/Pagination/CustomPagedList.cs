...
namespace MemberShipManage.Infrastructurer.Pagination
{
    ...
    public class CustomPagedList<T> : List<T>, ICustomPagedList<T>
    {
        ...
        public CustomPagedList(IEnumerable<T> source, int pageIndex, int pageSize)
        {
        ...
        public CustomPagedList(IEnumerable<T> source, int pageIndex, int pageSize, int totalCount)
        {
